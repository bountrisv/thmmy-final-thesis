\documentclass[11pt,a4paper,english,greek,twoside,fleqn]{auth-thesis}
\usepackage{epsfig}
...
\title{Προς την Αυτόματη Συγγραφή Κώδικα με Αναδραστικά Νευρωνικά Δίκτυα} %\en{(Source Code Generation with Recurrent Neural Networks)}}
\author{Βασίλης Μπούντρης}
\supervisor{Ανδρέας Συμεωνίδης}
%\TRnumber{ΟΕΣΤΛ-ΔΙΠΛ-2017-06} %TODO update
...
% References imported from `rnn2source.bib'. 
